...
A premium, highly interactive, and visually stunning 3D Developer Portfolio built using React, Vite, Three.js, and GSAP. Featuring sleek dark-mode glassmorphism, scroll-driven animations, custom interactive elements, and a fully-responsive design.

---

## 🌟 Key Features

*   **🖥️ Immersive 3D Canvas:** Includes a responsive 3D interactive Laptop/Scene model rendered with Three.js (React Three Fiber) that grounds the landing experience.
...
├── src/
│   ├── components/         # Reusable React components (3D Laptop, Navbar, etc.)
